<template>
  <div class="flex justify-center w-full">
    <div class="flex items-center w-full max-w-xs pb-10">
      ...
      >
        <div class="flex w-100 justify-center text-xl mb-4 font-bold">
          Subscribe
        </div>
        <div class="mb-4">
          <label
        ...
        <div v-if="subscriptionFailed" class="mb-6 italic text-red-500 text-sm">
        ...
        <div class="flex items-center justify-between">
          <button
            ...
            v-bind:class="{
              'hover:bg-blue-700 opacity-100 cursor-pointer': canSubmit,
